        ...
        <div class="w-full max-w-md space-y-8">
          <div>
            ...
            <p class="mt-2 text-center text-sm text-gray-600">
              Or
              <Link href={'/signup'} legacyBehavior><a href="#" class="font-medium text-red-600 hover:text-red-500"> Sign up</a></Link>
            </p>
          </div>
          <form class="mt-8 space-y-6" action="#" method="POST">
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="text-sm">
                <Link href={'/forgot'} legacyBehavior><a href="#" class="font-medium text-red-600 hover:text-red-500">Forgot your password?</a></Link>
              </div>
            </div>
