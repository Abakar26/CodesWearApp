...
export default function Home() {
  return (
    <>
      <Head>
        <title>MyCloths</title>
        <meta name="description" content="My wears.com wear my cloths" />
      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
            <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">My Clothing App Show</h1>
            <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Please select cloths which you want to wear on basis of your style</p>
          </div>
